...
# @Last Modified by:   Colinxu2020
# @Last Modified time: 2026-02-27 19:16:32
            ...
            if filename == "auto.json":
                ...
                for each_key in dict(auto_dict["data"]).keys():
                    ...
                    for task in auto_dict["data"][each_key]:
                        ...
                        if auto_sum_dict["data"][each_key].get(task["p_procname"]) is None:
                            auto_sum_dict["data"][each_key][task["p_procname"]] = [task]
                        else:
                            auto_sum_dict["data"][each_key][task["p_procname"]].append(task)
